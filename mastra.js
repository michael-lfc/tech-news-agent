...
export const techNewsAgent = new Agent({
  name: "tech_news_agent",
  instructions: "You are a helpful tech news assistant that fetches latest technology headlines.",
  model: {
    provider: "openai",
    name: "gpt-4",
  },
...
// ✅ Simple Mastra initialization
export const mastra = new Mastra({
  agents: [techNewsAgent],
});

console.log("✅ Mastra initialized with Tech News Agent (No workflow)");